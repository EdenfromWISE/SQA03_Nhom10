...
Test Cases:
    ...
    UT-VOC-VIEW-003 — TopicDetailView: trả topic kèm vocabulary list
...
class TestCourseDetailView:
    ...
    def test_UT_VOC_VIEW_002_course_detail_returns_correct_data(self, auth_client):
        # TC: UT-VOC-VIEW-002 — CourseDetailView trả đúng title và nested topics
...
class TestTopicDetailView:
    ...
    def test_UT_VOC_VIEW_003_topic_detail_returns_vocabulary_list(self, auth_client):
        # TC: UT-VOC-VIEW-003 — TopicDetailView trả đúng topic detail kèm vocabulary list
